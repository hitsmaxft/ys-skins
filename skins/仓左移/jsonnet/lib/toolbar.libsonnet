...
local getToolBar(theme) = {
  ...
  // 工具栏布局：对齐 Hamster 内置中文 26 键的 7 个图标。
  toolbarLayout: [{
    HStack: { subviews: [
      { Cell: 'toolbarRimeButton' },
  ...
  toolbarButtonBackgroundStyle: {
    ...
    highlightColor: '#FFFFFF18',
    cornerRadius: 7,
  },

  toolbarFlexibleSpacer: {
    // 占总宽 3/14，使左侧菜单独立、其余六键从约 150pt 起右对齐。
    size: { width: '3/14' },
  },

  toolbarRimeButton: {
    backgroundStyle: 'toolbarButtonBackgroundStyle',
    foregroundStyle: 'toolbarRimeButtonForegroundStyle',
    action: { shortcut: '#keyboardMenu' },
  },
  toolbarRimeButtonForegroundStyle: utils.makeSystemImageStyle({
    systemImageName: 'r.circle', normalColor: color[theme]['toolbar按键颜色'],
  ...
  toolbarPasteboardButtonForegroundStyle: utils.makeSystemImageStyle({
    systemImageName: 'clipboard', normalColor: color[theme]['toolbar按键颜色'],
    highlightColor: color[theme]['toolbar按键颜色'], fontSize: 19,
  }),
  ...
  toolbarSymbolButtonForegroundStyle: utils.makeSystemImageStyle({
    systemImageName: 'plus.slash.minus', normalColor: color[theme]['toolbar按键颜色'],
    highlightColor: color[theme]['toolbar按键颜色'], fontSize: 19,
  }),
  ...
  toolbarCloseButtonForegroundStyle: utils.makeSystemImageStyle({
    systemImageName: 'chevron.down.circle', normalColor: color[theme]['toolbar按键颜色'],
    highlightColor: color[theme]['toolbar按键颜色'], fontSize: 19,
  }),
  ...
  verticalCandidateCellStyle: {
    ...
    commentFontSize: 20,  // 保持原备注字号，不随候选文字联动
  },
